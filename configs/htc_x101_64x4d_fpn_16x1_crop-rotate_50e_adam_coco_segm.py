_base_ = '/mmdetection/configs/htc/htc_without_semantic_r50_fpn_1x_coco.py'
model = dict(
    backbone=dict(
        type='ResNeXt',
        depth=101,
...
data_root = '/mmdetection/data/flower_ct_dataset_ORA_NLMD_rotate_240123/'
img_norm_cfg = dict(
    mean=[25.4691, 23.1106, 24.8381], std=[46.4326, 39.8011, 44.0052], to_rgb=True)
